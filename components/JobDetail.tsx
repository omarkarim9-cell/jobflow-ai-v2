...
export const JobDetail: React.FC<JobDetailProps> = ({ job, userProfile, onUpdateJob, showNotification }) => {
  ...
  const handleGenerateDocuments = async () => {
    ...
    try {
        ...
        notify("Assets generated and saved!", "success");
    } catch (e) {
        console.error(e);
        notify("Failed to generate assets. Check your connection.", "error");
    } finally {
      ...
      <div className="p-8 max-w-5xl mx-auto w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col gap-3 w-full md:w-auto">
                ...
                >
                    Job Page <ExternalLink className="w-4 h-4" />
                </button>
                <button 
        ...
        <div className="grid grid-cols-1 gap-8">
            {/* Description Section */}
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-sm relative">
               <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-8 flex items-center gap-2">
                 <ChevronDown className="w-4 h-4 text-indigo-600" /> Job Description
               </h3>
              ...
              <div className="space-y-10 animate-in fade-in slide-in-from-bottom-10 duration-700">
                 <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-[11px] font-black text-indigo-500 uppercase tracking-[0.4em] whitespace-nowrap">AI Tailored Content</h3>
                    </div>
                    <div className="h-[1px] flex-1 bg-slate-200"></div>
                 </div>
                    ...
                    <div className="flex flex-col bg-white rounded-[3rem] border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                        <div className="p-8 bg-slate-50/50 border-b border-slate-100 flex justify-between items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <h4 className="text-xs font-black uppercase tracking-widest text-slate-800">Custom Resume</h4>
                            </div>
                        </div>
                        <div className="p-10 h-[600px] overflow-y-auto bg-white custom-scrollbar">
                ...
                <div className="p-16 text-center bg-slate-100/50 rounded-[2.5rem] border border-dashed border-slate-200">
                    ...
                    <h4 className="text-sm font-black text-slate-400 uppercase tracking-widest">No assets generated</h4>
                    <p className="text-xs text-slate-400 mt-2">Use the "Generate Assets" button above to create a tailored profile.</p>
                </div>
            )}
        </div>
      </div>
